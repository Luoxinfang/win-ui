    ...
    <div class="el-message-box__wrapper" v-show="value" @click.self="handleWrapperClick">
      <div class="el-message-box">
        <div class="el-message-box__header" v-if="title !== ''">
          ...
          <i class="el-message-box__close el-icon-close" @click="handleAction('cancel')"
             v-if="showClose"></i>
        </div>
        ...
        <div class="el-message-box__btns">
          <el-button :class="[ cancelButtonClasses ]" v-show="showCancelButton"
                     @click.native="handleAction('cancel')">{{ cancelButtonText }}
          </el-button>
          <el-button ref="confirm" :class="[ confirmButtonClasses ]" v-show="showConfirmButton"
                     @click.native="handleAction('confirm')">{{ confirmButtonText }}
          </el-button>
        </div>
      </div>
    </div>
